...
<html lang="en">
    ...
    <!-- Necesario para el script del thumbnail-slider -->
        ...
        <script src="{{asset('/js/jquery.dataTables.bootstrap.min.js')}}">
        </script>
        <script src="{{asset('/js/dataTables.buttons.min.js')}}">
        </script>
        <script src="{{asset('/js/buttons.flash.min.js')}}">
        </script>
        <script src="{{asset('/js/buttons.html5.min.js')}}">
        </script>
        <script src="{{asset('/js/buttons.print.min.js')}}">
        </script>
        <script src="{{asset('/js/buttons.colVis.min.js')}}">
        </script>
        <script src="{{asset('/js/dataTables.select.min.js')}}">
        </script>
        <script src="{{asset('/js/jquery-ui.custom.min.js')}}">
        </script>
        <script src="{{asset('/js/jquery.ui.touch-punch.min.js')}}">
        </script>
        <script src="{{asset('/js/chosen.jquery.min.js')}}">
        </script>
        <script src="{{asset('/js/spinbox.min.js')}}">
        </script>
        <script src="{{asset('/js/bootstrap-datepicker.min.js')}}">
        </script>
        <script src="{{asset('/js/bootstrap-timepicker.min.js')}}">
        </script>
        <script src="{{asset('/js/moment.min.js')}}">
        </script>
        <script src="{{asset('/js/daterangepicker.min.js')}}">
        </script>
        ...
        <script src="{{asset('/js/autosize.min.js')}}">
        </script>
        <script src="{{asset('/js/jquery.inputlimiter.min.js')}}">
        </script>
                ...
                <div class="navbar-buttons navbar-header pull-right" role="navigation">
                    <ul class="nav ace-nav">
                                    ...
                                    <ul class="dropdown-menu dropdown-navbar">
                                        <li>
                                            <a class="clearfix" href="#">
                                                <img alt="Alex's Avatar" class="msg-photo" src="{{asset('/images/avatars/avatar.png')}}"/>
                                                <span class="msg-body">
                                        ...
                                        <li>
                                            <a class="clearfix" href="#">
                                                <img alt="Susan's Avatar" class="msg-photo" src="{{asset('/images/avatars/avatar3.png')}}"/>
                                                <span class="msg-body">
                                                    <span class="msg-title">
                                                        <span class="blue">
                                                            Susan:
                                        ...
                                        <li>
                                            <a class="clearfix" href="#">
                                                <img alt="Bob's Avatar" class="msg-photo" src="{{asset('/images/avatars/avatar4.png')}}"/>
                                                <span class="msg-body">
                                                    <span class="msg-title">
                                                        <span class="blue">
                                                            Bob:
                                        ...
                                        <li>
                                            <a class="clearfix" href="#">
                                                <img alt="Kate's Avatar" class="msg-photo" src="{{asset('/images/avatars/avatar2.png')}}"/>
                                                <span class="msg-body">
                                                    <span class="msg-title">
                                                        <span class="blue">
                                                            Kate:
                                        ...
                                        <li>
                                            <a class="clearfix" href="#">
                                                <img alt="Fred's Avatar" class="msg-photo" src="{{asset('/images/avatars/avatar5.png')}}"/>
                                                <span class="msg-body">
                                                    <span class="msg-title">
                                                        <span class="blue">
                                                            Fred:
                        ...
                        <li class="light-blue dropdown-modal">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                <img alt="Jason's Photo" class="nav-user-photo" src="{{asset('/images/avatars/user.jpg')}}"/>
