            ...
            switch (Auth::user()->stringRol->nombre) {
                case 'admin':
                    $anuncios = DB::table('anuncios')
                        ...
                        ->join('provincias', 'localidades.idprovincia', '=', 'provincias.idprovincia')
                        ->join('users', 'anuncios.idusuario', '=', 'users.id')
                        ->select('anuncios.idanuncio', 'anuncios.titulo', 'anuncios.descripcion', 'anuncios.fechainicio', 'anuncios.fechafinal', 'anuncios.activo', 'anuncios.idlocalidad', 'provincias.nombre as NombreProvincia', 'localidades.nombre as NombreLocalidad', 'anuncios.idusuario', 'users.name as NombreUsuario')
